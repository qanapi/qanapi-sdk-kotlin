...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class cloud.qanapi.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class cloud.qanapi.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class cloud.qanapi.** {
    <init>(...);
