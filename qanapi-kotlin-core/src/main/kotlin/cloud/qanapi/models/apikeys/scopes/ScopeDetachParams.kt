...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ScopeDetachParams].
         *
    ...
    /** A builder for [ScopeDetachParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(scopeDetachParams: ScopeDetachParams) = apply {
            apiKey = scopeDetachParams.apiKey
            body = scopeDetachParams.body.toBuilder()
            additionalHeaders = scopeDetachParams.additionalHeaders.toBuilder()
            additionalQueryParams = scopeDetachParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ScopeDetachParams].
         *
