...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ScopeAttachParams].
         *
    ...
    /** A builder for [ScopeAttachParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(scopeAttachParams: ScopeAttachParams) = apply {
            apiKey = scopeAttachParams.apiKey
            body = scopeAttachParams.body.toBuilder()
            additionalHeaders = scopeAttachParams.additionalHeaders.toBuilder()
            additionalQueryParams = scopeAttachParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ScopeAttachParams].
         *
