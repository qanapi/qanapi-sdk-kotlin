...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ScopeSyncResponse]. */
        fun builder() = Builder()
    }

    /** A builder for [ScopeSyncResponse]. */
    class Builder internal constructor() {

        private var message: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(scopeSyncResponse: ScopeSyncResponse) = apply {
            message = scopeSyncResponse.message
            additionalProperties = scopeSyncResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ScopeSyncResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ScopeSyncResponse =
            ScopeSyncResponse(message, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ScopeSyncResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "ScopeSyncResponse{message=$message, additionalProperties=$additionalProperties}"
}
