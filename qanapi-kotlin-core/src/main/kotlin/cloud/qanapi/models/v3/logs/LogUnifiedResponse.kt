        ...
        private constructor(
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    @JsonProperty("roles")
                    @ExcludeMissing
                    fun _roles(): JsonField<List<Role>> = roles
                     ...
                     *
                     * Unlike [updatedAt], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("updated_at")
                    @ExcludeMissing
                    ...
                    class Builder internal constructor() {
                         ...
                         * Sets [Builder.id] to an arbitrary JSON value.
                         *
                         * You should usually call [Builder.id] with a well-typed [Long] value
                         ...
                         *
                         * You should usually call [Builder.roles] with a well-typed `List<Role>`
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        ...
                        fun updatedAt(updatedAt: OffsetDateTime) =
                            updatedAt(JsonField.of(updatedAt))
                    ...
                    private constructor(
                        ...
                        fun permissions(): List<Permission>? =
                            permissions.getNullable("permissions")
                        ...
                        class Builder internal constructor() {
                             ...
                             * `List<Permission>` value instead. This method is primarily for
                        ...
                        private constructor(
                            ...
                            /**
                             * @throws QanapiInvalidDataException if the JSON field has an
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    private constructor(
                        ...
                        @JsonProperty("user")
                        @ExcludeMissing
                        user: JsonField<User> = JsonMissing.of(),
                    ) : this(
                        id,
                        prefix,
                        status,
                     ...
                     *
                     * Unlike [revokedAt], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("revoked_at")
                    @ExcludeMissing
                    ...
                    class Builder internal constructor() {
                         ...
                         * `List<Configuration>` value instead. This method is primarily for setting
                         ...
                         *
                         * You should usually call [Builder.revokedAt] with a well-typed
                         * [OffsetDateTime] value instead. This method is primarily for setting the
                         * field to an undocumented or not yet supported value.
                         */
                    ...
                    private constructor(private val value: JsonField<String>) : Enum {
                         ...
                         *
                         * @throws QanapiInvalidDataException if this class instance's value is a
                         *   not a known member.
                         */
                        fun known(): Known =
                            when (this) {
                         ...
                         *
                         * @throws QanapiInvalidDataException if this class instance's value does
                         *   not have the expected primitive type.
                         */
                        fun asString(): String =
                            _value().asString()
                                ?: throw QanapiInvalidDataException("Value is not a String")
                    ...
                    private constructor(
                        ...
                        class Builder internal constructor() {
                            ...
                            internal fun from(configuration: Configuration) = apply {
                                ...
                                values = configuration.values.map { it.toMutableList() }
                                additionalProperties =
                                    configuration.additionalProperties.toMutableMap()
                            }
                             ...
                             * `List<Value>` value instead. This method is primarily for setting the
                             * field to an undocumented or not yet supported value.
                             */
                            fun values(values: JsonField<List<Value>>) = apply {
                                this.values = values.map { it.toMutableList() }
                    ...
                    private constructor(
                        ...
                        private constructor(
                            @JsonProperty("id")
                            @ExcludeMissing
                            id: JsonField<Long> = JsonMissing.of(),
                            @JsonProperty("email")
                            @ExcludeMissing
                            email: JsonField<String> = JsonMissing.of(),
                            @JsonProperty("name")
                         ...
                         * Returns the raw JSON value of [roles].
                         *
                         * Unlike [roles], this method doesn't throw if the JSON field has an
                         * unexpected type.
                         */
                        @JsonProperty("roles")
                        @ExcludeMissing
                         ...
                         * Returns the raw JSON value of [twoFactorEnabled].
                         *
                         * Unlike [twoFactorEnabled], this method doesn't throw if the JSON field
                        ...
                        class Builder internal constructor() {
                             ...
                             * Sets [Builder.roles] to an arbitrary JSON value.
                             *
                             * You should usually call [Builder.roles] with a well-typed
                             * `List<Role>` value instead. This method is primarily for setting the
                             * field to an undocumented or not yet supported value.
                             */
                            fun roles(roles: JsonField<List<Role>>) = apply {
                                this.roles = roles.map { it.toMutableList() }
                        ...
                        private constructor(
                             ...
                             * Returns the raw JSON value of [permissions].
                             *
                             * Unlike [permissions], this method doesn't throw if the JSON field has
                             * an unexpected type.
                             */
                            @JsonProperty("permissions")
                            @ExcludeMissing
                            ...
                            private constructor(
                                 ...
                                 *
                                 * @throws QanapiInvalidDataException if any value type in this
