...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userCreateResponse: UserCreateResponse) = apply {
            ...
            roles = userCreateResponse.roles.map { it.toMutableList() }
            twoFactorEnabled = userCreateResponse.twoFactorEnabled
    ...
    override fun toString() =
        "UserCreateResponse{id=$id, email=$email, name=$name, createdAt=$createdAt, roles=$roles, twoFactorEnabled=$twoFactorEnabled, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
