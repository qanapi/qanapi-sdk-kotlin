...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(apiKeyListResponse: ApiKeyListResponse) = apply {
            ...
            prefix = apiKeyListResponse.prefix
            status = apiKeyListResponse.status
            configurations = apiKeyListResponse.configurations.map { it.toMutableList() }
            createdAt = apiKeyListResponse.createdAt
            permissions = apiKeyListResponse.permissions.map { it.toMutableList() }
            revokedAt = apiKeyListResponse.revokedAt
            updatedAt = apiKeyListResponse.updatedAt
            user = apiKeyListResponse.user
    ...
    override fun toString() =
        "ApiKeyListResponse{id=$id, prefix=$prefix, status=$status, configurations=$configurations, createdAt=$createdAt, permissions=$permissions, revokedAt=$revokedAt, updatedAt=$updatedAt, user=$user, additionalProperties=$additionalProperties}"
}
