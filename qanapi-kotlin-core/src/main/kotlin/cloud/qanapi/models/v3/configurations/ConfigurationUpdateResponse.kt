...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConfigurationUpdateResponse].
         *
    ...
    /** A builder for [ConfigurationUpdateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(configurationUpdateResponse: ConfigurationUpdateResponse) = apply {
            id = configurationUpdateResponse.id
            name = configurationUpdateResponse.name
            type = configurationUpdateResponse.type
            values = configurationUpdateResponse.values.map { it.toMutableList() }
            additionalProperties = configurationUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConfigurationUpdateResponse].
         *
         ...
         */
        fun build(): ConfigurationUpdateResponse =
     ...
     *   expected type.
     */
    fun validate(): ConfigurationUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConfigurationUpdateResponse &&
            id == other.id &&
            name == other.name &&
            type == other.type &&
            values == other.values &&
    ...
    override fun toString() =
        "ConfigurationUpdateResponse{id=$id, name=$name, type=$type, values=$values, additionalProperties=$additionalProperties}"
}
