...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GoogleGroup].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(googleGroup: GoogleGroup) = apply {
            id = googleGroup.id
            email = googleGroup.email
            name = googleGroup.name
            additionalProperties = googleGroup.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GoogleGroup].
         *
         ...
         */
        fun build(): GoogleGroup =
            GoogleGroup(checkRequired("id", id), email, name, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): GoogleGroup = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "GoogleGroup{id=$id, email=$email, name=$name, additionalProperties=$additionalProperties}"
}
