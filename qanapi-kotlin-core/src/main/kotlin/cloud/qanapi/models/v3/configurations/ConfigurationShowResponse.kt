...
class ConfigurationShowResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConfigurationShowResponse].
         *
    ...
    /** A builder for [ConfigurationShowResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(configurationShowResponse: ConfigurationShowResponse) = apply {
            id = configurationShowResponse.id
            name = configurationShowResponse.name
            type = configurationShowResponse.type
            values = configurationShowResponse.values.map { it.toMutableList() }
            additionalProperties = configurationShowResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConfigurationShowResponse].
         *
         ...
         */
        fun build(): ConfigurationShowResponse =
     ...
     *   expected type.
     */
    fun validate(): ConfigurationShowResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConfigurationShowResponse &&
            id == other.id &&
            name == other.name &&
            type == other.type &&
            values == other.values &&
    ...
    override fun toString() =
        "ConfigurationShowResponse{id=$id, name=$name, type=$type, values=$values, additionalProperties=$additionalProperties}"
}
