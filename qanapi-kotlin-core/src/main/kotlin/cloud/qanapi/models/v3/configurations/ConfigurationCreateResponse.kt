...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConfigurationCreateResponse].
         *
    ...
    /** A builder for [ConfigurationCreateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(configurationCreateResponse: ConfigurationCreateResponse) = apply {
            id = configurationCreateResponse.id
            name = configurationCreateResponse.name
            type = configurationCreateResponse.type
            values = configurationCreateResponse.values.map { it.toMutableList() }
            additionalProperties = configurationCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConfigurationCreateResponse].
         *
         ...
         */
        fun build(): ConfigurationCreateResponse =
     ...
     *   expected type.
     */
    fun validate(): ConfigurationCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConfigurationCreateResponse &&
            id == other.id &&
            name == other.name &&
            type == other.type &&
            values == other.values &&
    ...
    override fun toString() =
        "ConfigurationCreateResponse{id=$id, name=$name, type=$type, values=$values, additionalProperties=$additionalProperties}"
}
