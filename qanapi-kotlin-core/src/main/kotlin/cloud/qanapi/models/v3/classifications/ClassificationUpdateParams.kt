...
class ClassificationUpdateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ClassificationUpdateParams].
         *
    ...
    /** A builder for [ClassificationUpdateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(classificationUpdateParams: ClassificationUpdateParams) = apply {
            classification = classificationUpdateParams.classification
            body = classificationUpdateParams.body.toBuilder()
            additionalHeaders = classificationUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = classificationUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ClassificationUpdateParams].
         *
         ...
         */
        fun build(): ClassificationUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ClassificationUpdateParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(classification, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ClassificationUpdateParams{classification=$classification, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
