...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ClassificationUpdateResponse].
         *
    ...
    /** A builder for [ClassificationUpdateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(classificationUpdateResponse: ClassificationUpdateResponse) = apply {
            id = classificationUpdateResponse.id
            bgColor = classificationUpdateResponse.bgColor
            fgColor = classificationUpdateResponse.fgColor
            name = classificationUpdateResponse.name
            slug = classificationUpdateResponse.slug
            description = classificationUpdateResponse.description
            emoji = classificationUpdateResponse.emoji
            providers = classificationUpdateResponse.providers.map { it.toMutableList() }
            roles = classificationUpdateResponse.roles.map { it.toMutableList() }
            users = classificationUpdateResponse.users.map { it.toMutableList() }
            additionalProperties = classificationUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ClassificationUpdateResponse].
         *
         ...
         */
        fun build(): ClassificationUpdateResponse =
     ...
     *   expected type.
     */
    fun validate(): ClassificationUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ClassificationUpdateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "ClassificationUpdateResponse{id=$id, bgColor=$bgColor, fgColor=$fgColor, name=$name, slug=$slug, description=$description, emoji=$emoji, providers=$providers, roles=$roles, users=$users, additionalProperties=$additionalProperties}"
}
