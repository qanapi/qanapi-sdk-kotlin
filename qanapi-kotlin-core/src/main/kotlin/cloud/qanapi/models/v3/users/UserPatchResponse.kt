...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserPatchResponse].
         *
    ...
    /** A builder for [UserPatchResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(userPatchResponse: UserPatchResponse) = apply {
            id = userPatchResponse.id
            email = userPatchResponse.email
            name = userPatchResponse.name
            createdAt = userPatchResponse.createdAt
            roles = userPatchResponse.roles.map { it.toMutableList() }
            twoFactorEnabled = userPatchResponse.twoFactorEnabled
            updatedAt = userPatchResponse.updatedAt
            additionalProperties = userPatchResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserPatchResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): UserPatchResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserPatchResponse &&
            id == other.id &&
            email == other.email &&
            name == other.name &&
    ...
    override fun toString() =
        "UserPatchResponse{id=$id, email=$email, name=$name, createdAt=$createdAt, roles=$roles, twoFactorEnabled=$twoFactorEnabled, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
