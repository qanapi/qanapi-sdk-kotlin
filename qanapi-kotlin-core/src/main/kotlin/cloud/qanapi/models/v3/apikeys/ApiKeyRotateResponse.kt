...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): ApiKeyRotateResponse =
            ApiKeyRotateResponse(key, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "ApiKeyRotateResponse{key=$key, additionalProperties=$additionalProperties}"
}
