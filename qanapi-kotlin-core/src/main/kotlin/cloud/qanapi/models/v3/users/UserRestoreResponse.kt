...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserRestoreResponse].
         *
    ...
    /** A builder for [UserRestoreResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(userRestoreResponse: UserRestoreResponse) = apply {
            id = userRestoreResponse.id
            email = userRestoreResponse.email
            name = userRestoreResponse.name
            createdAt = userRestoreResponse.createdAt
            roles = userRestoreResponse.roles.map { it.toMutableList() }
            twoFactorEnabled = userRestoreResponse.twoFactorEnabled
            updatedAt = userRestoreResponse.updatedAt
            additionalProperties = userRestoreResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserRestoreResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): UserRestoreResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserRestoreResponse &&
            id == other.id &&
            email == other.email &&
            name == other.name &&
    ...
    override fun toString() =
        "UserRestoreResponse{id=$id, email=$email, name=$name, createdAt=$createdAt, roles=$roles, twoFactorEnabled=$twoFactorEnabled, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
