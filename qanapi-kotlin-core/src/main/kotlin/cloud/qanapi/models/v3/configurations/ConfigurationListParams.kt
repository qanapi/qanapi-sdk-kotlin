...
private constructor(
    ...
    companion object {
        ...
        fun none(): ConfigurationListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun build(): ConfigurationListParams =
            ConfigurationListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ConfigurationListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
