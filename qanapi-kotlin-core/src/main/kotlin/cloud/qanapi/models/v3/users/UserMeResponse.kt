...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userMeResponse: UserMeResponse) = apply {
            ...
            createdAt = userMeResponse.createdAt
            roles = userMeResponse.roles.map { it.toMutableList() }
            twoFactorEnabled = userMeResponse.twoFactorEnabled
            updatedAt = userMeResponse.updatedAt
    ...
    override fun toString() =
        "UserMeResponse{id=$id, email=$email, name=$name, createdAt=$createdAt, roles=$roles, twoFactorEnabled=$twoFactorEnabled, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
