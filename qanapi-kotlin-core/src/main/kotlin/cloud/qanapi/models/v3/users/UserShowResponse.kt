...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserShowResponse].
         *
    ...
    /** A builder for [UserShowResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(userShowResponse: UserShowResponse) = apply {
            id = userShowResponse.id
            email = userShowResponse.email
            name = userShowResponse.name
            createdAt = userShowResponse.createdAt
            roles = userShowResponse.roles.map { it.toMutableList() }
            twoFactorEnabled = userShowResponse.twoFactorEnabled
            updatedAt = userShowResponse.updatedAt
            additionalProperties = userShowResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserShowResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): UserShowResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserShowResponse &&
            id == other.id &&
            email == other.email &&
            name == other.name &&
    ...
    override fun toString() =
        "UserShowResponse{id=$id, email=$email, name=$name, createdAt=$createdAt, roles=$roles, twoFactorEnabled=$twoFactorEnabled, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
