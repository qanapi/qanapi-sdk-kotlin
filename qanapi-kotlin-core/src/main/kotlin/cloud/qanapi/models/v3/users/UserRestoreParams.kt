...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userRestoreParams: UserRestoreParams) = apply {
            ...
            body = userRestoreParams.body.toBuilder()
    ...
    override fun toString() =
        "UserRestoreParams{user=$user, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
