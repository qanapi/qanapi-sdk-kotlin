...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(configurationCreateParams: ConfigurationCreateParams) = apply {
            body = configurationCreateParams.body.toBuilder()
    ...
    private constructor(
        ...
        ) : this(name, type, provider, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(name, type, provider, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{name=$name, type=$type, provider=$provider, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        fun known(): Known =
            when (this) {
                ...
                else -> throw QanapiInvalidDataException("Unknown Type: $value")
            }
    ...
    class Provider @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        fun known(): Known =
            when (this) {
                GOOGLE -> Known.GOOGLE
                else -> throw QanapiInvalidDataException("Unknown Provider: $value")
            }
    ...
    override fun toString() =
        "ConfigurationCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
