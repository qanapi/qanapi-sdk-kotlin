...
class ClassificationShowResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ClassificationShowResponse].
         *
    ...
    /** A builder for [ClassificationShowResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(classificationShowResponse: ClassificationShowResponse) = apply {
            id = classificationShowResponse.id
            bgColor = classificationShowResponse.bgColor
            fgColor = classificationShowResponse.fgColor
            name = classificationShowResponse.name
            slug = classificationShowResponse.slug
            description = classificationShowResponse.description
            emoji = classificationShowResponse.emoji
            providers = classificationShowResponse.providers.map { it.toMutableList() }
            roles = classificationShowResponse.roles.map { it.toMutableList() }
            users = classificationShowResponse.users.map { it.toMutableList() }
            additionalProperties = classificationShowResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ClassificationShowResponse].
         *
         ...
         */
        fun build(): ClassificationShowResponse =
     ...
     *   expected type.
     */
    fun validate(): ClassificationShowResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ClassificationShowResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "ClassificationShowResponse{id=$id, bgColor=$bgColor, fgColor=$fgColor, name=$name, slug=$slug, description=$description, emoji=$emoji, providers=$providers, roles=$roles, users=$users, additionalProperties=$additionalProperties}"
}
