...
private constructor(
    ...
    companion object {
        ...
        fun none(): ScopeUpdateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ScopeUpdateParams]. */
        fun builder() = Builder()
    }

    /** A builder for [ScopeUpdateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(scopeUpdateParams: ScopeUpdateParams) = apply {
            id = scopeUpdateParams.id
            body = scopeUpdateParams.body.toBuilder()
            additionalHeaders = scopeUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = scopeUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ScopeUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ScopeUpdateParams =
            ScopeUpdateParams(
                id,
                body.build(),
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(name, route, additionalProperties.toMutableMap())
        }
        ...
        internal fun validity(): Int =
            (if (name.asKnown() == null) 0 else 1) + (if (route.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && name == other.name && route == other.route && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(name, route, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{name=$name, route=$route, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ScopeUpdateParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(id, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ScopeUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
