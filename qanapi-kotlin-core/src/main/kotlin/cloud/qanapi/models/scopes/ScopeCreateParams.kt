...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ScopeCreateParams].
         *
    ...
    /** A builder for [ScopeCreateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(scopeCreateParams: ScopeCreateParams) = apply {
            body = scopeCreateParams.body.toBuilder()
            additionalHeaders = scopeCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = scopeCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ScopeCreateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ScopeCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ScopeCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
