...
private constructor(
    ...
    ) : this(id, createdAt, name, route, updatedAt, mutableMapOf())
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ScopeCreateResponse]. */
        fun builder() = Builder()
    }

    /** A builder for [ScopeCreateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(scopeCreateResponse: ScopeCreateResponse) = apply {
            id = scopeCreateResponse.id
            createdAt = scopeCreateResponse.createdAt
            name = scopeCreateResponse.name
            route = scopeCreateResponse.route
            updatedAt = scopeCreateResponse.updatedAt
            additionalProperties = scopeCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ScopeCreateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ScopeCreateResponse =
            ScopeCreateResponse(
                id,
                createdAt,
                name,
    ...
    fun validate(): ScopeCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ScopeCreateResponse && id == other.id && createdAt == other.createdAt && name == other.name && route == other.route && updatedAt == other.updatedAt && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ScopeCreateResponse{id=$id, createdAt=$createdAt, name=$name, route=$route, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
