...
interface ApiKeyServiceAsync {
    ...
    /** @see revoke */
    suspend fun revoke(apiKey: Long, requestOptions: RequestOptions) =
    ...
    /** @see rotate */
    suspend fun rotate(apiKey: Long, requestOptions: RequestOptions): ApiKeyRotateResponse =
    ...
    interface WithRawResponse {
        ...
        /** @see revoke */
        @MustBeClosed
        suspend fun revoke(apiKey: Long, requestOptions: RequestOptions): HttpResponse =
            revoke(apiKey, ApiKeyRevokeParams.none(), requestOptions)
