...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ScopeListResponse]. */
        fun builder() = Builder()
    }

    /** A builder for [ScopeListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(scopeListResponse: ScopeListResponse) = apply {
            id = scopeListResponse.id
            createdAt = scopeListResponse.createdAt
            name = scopeListResponse.name
            route = scopeListResponse.route
            updatedAt = scopeListResponse.updatedAt
            additionalProperties = scopeListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ScopeListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ScopeListResponse =
            ScopeListResponse(
                id,
                createdAt,
                name,
    ...
    fun validate(): ScopeListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ScopeListResponse && id == other.id && createdAt == other.createdAt && name == other.name && route == other.route && updatedAt == other.updatedAt && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ScopeListResponse{id=$id, createdAt=$createdAt, name=$name, route=$route, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
