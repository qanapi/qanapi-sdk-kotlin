...
dependencies {
    testImplementation(project(":qanapi-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../qanapi-kotlin-core/src/main/resources/META-INF/proguard/qanapi-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("cloud.qanapi.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../qanapi-kotlin-core/src/main/resources/META-INF/proguard/qanapi-kotlin-core.pro",
