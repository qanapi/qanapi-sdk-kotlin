...
[![Maven Central](https://img.shields.io/maven-central/v/cloud.qanapi/qanapi-kotlin)](https://central.sonatype.com/artifact/cloud.qanapi/qanapi-kotlin/1.7.0)
[![javadoc](https://javadoc.io/badge2/cloud.qanapi/qanapi-kotlin/javadoc.svg)](https://javadoc.io/doc/cloud.qanapi/qanapi-kotlin/1.7.0)
...
The REST API documentation can be found on [docs.qanapi.com](https://docs.qanapi.com/). KDocs are available on [javadoc.io](https://javadoc.io/doc/cloud.qanapi/qanapi-kotlin/1.7.0).
...
```kotlin
implementation("cloud.qanapi:qanapi-kotlin:1.7.0")
```
