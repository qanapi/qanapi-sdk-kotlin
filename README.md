...
[![Maven Central](https://img.shields.io/maven-central/v/cloud.qanapi/qanapi-kotlin)](https://central.sonatype.com/artifact/cloud.qanapi/qanapi-kotlin/1.1.4)
[![javadoc](https://javadoc.io/badge2/cloud.qanapi/qanapi-kotlin/1.1.4/javadoc.svg)](https://javadoc.io/doc/cloud.qanapi/qanapi-kotlin/1.1.4)
...
The REST API documentation can be found on [www.qanapi.com](https://www.qanapi.com/docs). KDocs are available on [javadoc.io](https://javadoc.io/doc/cloud.qanapi/qanapi-kotlin/1.1.4).
...
```kotlin
implementation("cloud.qanapi:qanapi-kotlin:1.1.4")
```
